...
class QuestionModelsTests(TestCase):
    ...
    def test_was_publshed_with_recent_question(self):
        """
...
def create_question(question_text, days):
    ...
    offset to now (negative for questions publisehd in the past, positive for questions that
    have yet to be publisehd).
    """
...
class QuestionIndexViewsTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both and future questions exits, only past questions are displayed.
        """
        question = create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse("polls:index"))
